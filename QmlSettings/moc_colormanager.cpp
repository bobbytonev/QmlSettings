...
QT_MOC_LITERAL(3, 28, 17), // "colorsNameChanged"
QT_MOC_LITERAL(4, 46, 8), // "settings"
QT_MOC_LITERAL(5, 55, 3), // "str"
QT_MOC_LITERAL(6, 59, 6), // "colors"
QT_MOC_LITERAL(7, 66, 10) // "colorsName"

    },
    "ColorManager\0colorsChanged\0\0"
    "colorsNameChanged\0settings\0str\0colors\0"
    "colorsName"
};
...
void ColorManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->colorsNameChanged(); break;
        ...
        {
            using _t = void (ColorManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorManager::colorsChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ColorManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorManager::colorsNameChanged)) {
                *result = 1;
                return;
            }
        }
        ...
        case 1: *reinterpret_cast< QVariantList*>(_v) = _t->colorsName(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setColors(*reinterpret_cast< QVariantList*>(_v)); break;
        case 1: _t->setColorsName(*reinterpret_cast< QVariantList*>(_v)); break;
        default: break;
        }
...
// SIGNAL 0
void ColorManager::colorsChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void ColorManager::colorsNameChanged()
{
