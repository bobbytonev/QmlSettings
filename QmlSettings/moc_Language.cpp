...
QT_MOC_LITERAL(1, 9, 14), // "languageChange"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 4), // "load"
QT_MOC_LITERAL(4, 30, 8) // "language"

    },
    "Language\0languageChange\0\0load\0language"
};
...
static const uint qt_meta_data_Language[] = {
 ...
 // properties: name, type, flags
       4, QMetaType::QVariantList, 0x00495103,
...
void Language::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { QVariantList _r = _t->load();
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Language::languageChange)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QVariantList*>(_v) = _t->language(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setLanguage(*reinterpret_cast< QVariantList*>(_v)); break;
        default: break;
        }
